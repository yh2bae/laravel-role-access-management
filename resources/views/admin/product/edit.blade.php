                ...
                <form action="{{ route('product.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="mb-3">
                                <label for="name_en" class="form-label">Indonesia Product Name</label>
                                <input type="text" id="name_en" name="name_en" value="{{ old('name_en', $product->name_en) }}"
                                class="form-control @error('name_en') is-invalid @enderror" placeholder="Enter indonesia product name">
                                @error('name_en')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
